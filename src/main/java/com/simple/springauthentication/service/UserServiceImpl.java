...
import com.simple.springauthentication.repository.RoleRepository;
import com.simple.springauthentication.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
    ...
    public String deleteUser(User user) {
        log.info("deleting existing user {} to the database", user.getName());
